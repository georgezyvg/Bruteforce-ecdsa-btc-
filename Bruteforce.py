...
public_key = {27004723988676857008202351383256143730916999854504849485400079062037459075774,
95496386914076749971936405657077055430572082484415724230124294886743936876523}
...
def find_public_key_x_public_key_y_and_private_key(public_key, generator_x, generator_y, p):
  ...
  while (result_x, result_y) != public_key:
    ...
    counter += 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
